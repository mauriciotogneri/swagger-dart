class StatusCode {
  ...
  static const int NON_ACCEPTABLE = 406;
  ...
  static const int UPGRADED_REQUIRED = 426;
  static const int PRECONDITION_REQUIRED = 428;
  static const int TOO_MANY_REQUESTS = 429;
  static const int REQUEST_HEADER_FIELD_TOO_LARGE = 431;
  ...
  static const int BANWIDTH_LIMIT_EXCEEDED = 509;
  static const int NOT_EXTENDED = 510;
  static const int NETWORK_AUTHENTICATION_REQUIRED = 511;
  static const int NETWORK_READ_TIMEOUT = 598;
